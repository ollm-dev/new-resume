...
/**
 * @component About
 * @description 个人信息展示组件，包含个人简介、生活掠影、座右铭等信息
  ...
  return (
    <section id="about" className="py-16 md:py-20 bg-white">
      <div className="container mx-auto px-4 md:px-6 space-y-14">
        ...
        {/* Motto */}
        <div className="bg-gradient-to-r from-resume-blue/10 to-resume-blue/5 rounded-lg p-8 shadow-sm border border-resume-blue/20 transform hover:scale-[1.01] transition-transform">
          <div className="flex items-center gap-4 mb-5">
            <Quote className="text-resume-blue h-7 w-7" />
            <h3 className="text-2xl font-semibold text-resume-blue">座右铭</h3>
          </div>
          <blockquote className="italic text-lg text-gray-700 border-l-4 border-resume-blue pl-6 py-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="shadow-md hover:shadow-lg transition-all overflow-hidden group">
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2.5 rounded-full bg-resume-blue/10">
          ...
          <Card className="shadow-md hover:shadow-lg transition-all overflow-hidden group">
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2.5 rounded-full bg-resume-accent/10">
                  <Lightbulb className="h-6 w-6 text-resume-accent" />
                </div>
                <h3 className="font-semibold text-lg text-resume-accent">创新思维</h3>
              </div>
              <p className="text-gray-700">
          ...
          <Card className="shadow-md hover:shadow-lg transition-all overflow-hidden group">
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2.5 rounded-full bg-resume-blue/10">
                  <HeartHandshake className="h-6 w-6 text-resume-blue" />
                </div>
                <h3 className="font-semibold text-lg text-resume-blue">团队协作</h3>
              </div>
              <p className="text-gray-700">
            ...
            <CardContent className="pt-8 px-8 pb-6">
              <div className="space-y-6">
                <div className="flex items-start gap-5">
                  <div className="mt-1 bg-resume-blue/10 p-2.5 rounded-full flex-shrink-0">
                    <GraduationCap className="h-6 w-6 text-resume-blue" />
                  </div>
                  <div>
                    <h3 className="font-medium text-lg text-gray-900 mb-1">教育背景</h3>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="font-medium text-lg text-gray-900 mb-1">求职意向</h3>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="font-medium text-lg text-gray-900 mb-1">个人理念</h3>
          ...
          <Card className="shadow-sm hover:shadow-md transition-shadow overflow-hidden">
            ...
            <CardContent className="pt-8 px-8 pb-6">
              <div className="space-y-6">
                <div className="flex items-start gap-5">
                  <div className="mt-1 bg-resume-blue/10 p-2.5 rounded-full flex-shrink-0">
                    <MapPin className="h-6 w-6 text-resume-blue" />
                  </div>
                  <div>
                    <h3 className="font-medium text-lg text-gray-900 mb-1">所在地区</h3>
                ...
                <div className="flex items-start gap-5">
                  <div className="mt-1 bg-resume-blue/10 p-2.5 rounded-full flex-shrink-0">
                    <Mail className="h-6 w-6 text-resume-blue" />
                  </div>
                  <div>
                    <h3 className="font-medium text-lg text-gray-900 mb-1">电子邮箱</h3>
                ...
                <div className="flex items-start gap-5">
                  <div className="mt-1 bg-resume-blue/10 p-2.5 rounded-full flex-shrink-0">
                    <Phone className="h-6 w-6 text-resume-blue" />
                  </div>
                  <div>
                    <h3 className="font-medium text-lg text-gray-900 mb-1">联系电话</h3>
                ...
                <div className="flex items-start gap-5">
                  <div className="mt-1 bg-resume-blue/10 p-2.5 rounded-full flex-shrink-0">
                    <BookOpen className="h-6 w-6 text-resume-blue" />
                  </div>
                  <div>
                    <h3 className="font-medium text-lg text-gray-900 mb-1">格言</h3>
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-200 transform hover:translate-y-[-5px] transition-transform">
          <h3 className="text-2xl font-semibold text-resume-blue mb-5 flex items-center gap-3">
            <div className="h-7 w-1.5 bg-resume-blue rounded-full"></div>
            学业成绩与荣誉
          </h3>
